...
<form name="ctpm_conta_pagar_modificada" action="portal.jsp" method="post"   >                                         
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/easyconstru/ctpm_conta_pagar_modificada/ctpm_conta_pagar_modificadaUpdateDelete.jsp"/>
    <center>     
    ...
    <table align="center" border="0" width="50%">
    		     <tr>
	<td>
		<label>ctpm_nr_id:</label>
	</td>
	<td>
		<input type="text" name="ctpm_conta_pagar_modificadaT.ctpm_nr_id" value="${ctpm_conta_pagar_modificadaJB.ctpm_conta_pagar_modificadaT.ctpm_nr_id}" onKeyPress="nextField(this, event)"/> 
	</td>
     </tr>
<tr>
	<td>
...
<tr>
	...
	<td>
	  ...
	  <tr>
		...
		<input type="button" value="Consult" onClick="setOpPortal('ctpm_conta_pagar_modificada', 'consult', '/easyEngenharia/easyconstru/ctpm_conta_pagar_modificada/ctpm_conta_pagar_modificadaConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Update"  onClick="setOpPortal('ctpm_conta_pagar_modificada', 'update' , '/easyEngenharia/easyconstru/ctpm_conta_pagar_modificada/ctpm_conta_pagar_modificadaUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Delete"  onClick="setOpPortal('ctpm_conta_pagar_modificada', 'delete' , '/easyEngenharia/easyconstru/ctpm_conta_pagar_modificada/ctpm_conta_pagar_modificadaUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Cancel"  onClick="setOpPortal('ctpm_conta_pagar_modificada', 'consult' , '/easyEngenharia/easyconstru/ctpm_conta_pagar_modificada/ctpm_conta_pagar_modificadaConsult.jsp')" />
    	    </td>
	  </tr>
	</table>
