...
<form name="rep_resumo_planejamento" action="portal.jsp" method="post"   > 
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/bi/rep_resumo_planejamento/rep_resumo_planejamentoInsert.jsp"/>
...
<table align="left" width="600" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    			    <input type="button" class="ms-ButtonHeightWidth" value="Cadastrar"  onClick="setOpPortal('rep_resumo_planejamento','insert', '/easyEngenharia/bi/rep_resumo_planejamento/rep_resumo_planejamentoInsert.jsp')" /> &nbsp;&nbsp;
    			    <!--input type="reset"  value="Clear" onclick="setOpPortal('rep_resumo_planejamento','Limpar', '/easyEngenharia/bi/rep_resumo_planejamento/rep_resumo_planejamentoInsert.jsp')"/-->&nbsp;&nbsp;
    			    <input type="button" class="ms-ButtonHeightWidth" value="Voltar"  onClick="setOpPortal('rep_resumo_planejamento','', '/easyEngenharia/bi/rep_resumo_planejamento/rep_resumo_planejamentoConsult.jsp')" />
    </div></td>
  </tr>
</table>
<br/>
