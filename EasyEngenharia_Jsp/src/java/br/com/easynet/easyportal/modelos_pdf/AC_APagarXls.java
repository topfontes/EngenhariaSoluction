...
public class AC_APagarXls {
    ...
    public AC_APagarXls(Ctp_conta_pagarT ctp_conta_pagarT, Ctp_conta_pagarDAO cdao, InputStream is) throws Exception {
    ...
    public String read() {
        ...
        try {
            ...
            for (int i = 11; i < (sheet.getRows() - 1); i++) {
                ...
                if (isData(sheet.getCell(8, i).getContents().trim())) {
                    dt_emissao = sheet.getCell(8, i).getContents().trim();
                    ...
                    //data = sheet.getCell(8, i).getContents().trim();
