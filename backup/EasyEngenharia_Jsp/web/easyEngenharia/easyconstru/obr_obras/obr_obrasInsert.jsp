...
<form name="obr_obras" action="portal.jsp" method="post"   > 
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/easyconstru/obr_obras/obr_obrasInsert.jsp"/>
    <center>     
	...
	<td>
		...
		<tr>
			<td colspan="2" align="center">
    			    <input type="button" value="Insert"  onClick="setOpPortal('obr_obras','insert', '/easyEngenharia/easyconstru/obr_obras/obr_obrasInsert.jsp')" /> &nbsp;&nbsp;
    			    <input type="reset"  value="Clear" onclick="setOpPortal('obr_obras','clear', '/easyEngenharia/easyconstru/obr_obras/obr_obrasInsert.jsp')"/>&nbsp;&nbsp;
    			    <input type="button" value="Voltar"  onClick="setOpPortal('obr_obras','', '/easyEngenharia/easyconstru/obr_obras/obr_obrasConsult.jsp')" />
			</td>
		</tr>
    	</table>
    </center>     
