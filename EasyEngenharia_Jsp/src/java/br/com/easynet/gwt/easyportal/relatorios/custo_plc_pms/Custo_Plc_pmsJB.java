...
import br.com.easynet.gwt.easyportal.jb.ResponseSessionJB;
...
public class Custo_Plc_pmsJB extends SystemBase {
    ...
    public void imprimir() {
        String vl = "false";
        getSession().setAttribute(ResponseSessionJB.SESSION_RESPONSE, vl);
 ...
 */
            ...
            xls.setParameter(JRXlsExporterParameter.MAXIMUM_ROWS_PER_SHEET,Integer.decode("165000"));
            ...
            String vlres ="true";
            getSession().setAttribute(ResponseSessionJB.SESSION_RESPONSE, vlres);
            //odao.close();
            close();
        }
    }
