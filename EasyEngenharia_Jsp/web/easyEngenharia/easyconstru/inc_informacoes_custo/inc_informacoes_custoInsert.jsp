...
<form name="inc_informacoes_custo" action="portal.jsp" method="post"   > 
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/easyconstru/inc_informacoes_custo/inc_informacoes_custoInsert.jsp"/>
    <center>     
	...
	<td>
		...
		<tr>
			<td colspan="2" align="center">
    			    <input type="button" value="Insert"  onClick="setOpPortal('inc_informacoes_custo','insert', '/easyEngenharia/easyconstru/inc_informacoes_custo/inc_informacoes_custoInsert.jsp')" /> &nbsp;&nbsp;
    			    <input type="reset"  value="Clear" onclick="setOpPortal('inc_informacoes_custo','clear', '/easyEngenharia/easyconstru/inc_informacoes_custo/inc_informacoes_custoInsert.jsp')"/>&nbsp;&nbsp;
    			    <input type="button" value="Voltar"  onClick="setOpPortal('inc_informacoes_custo','', '/easyEngenharia/easyconstru/inc_informacoes_custo/inc_informacoes_custoConsult.jsp')" />
			</td>
		</tr>
    	</table>
    </center>     
