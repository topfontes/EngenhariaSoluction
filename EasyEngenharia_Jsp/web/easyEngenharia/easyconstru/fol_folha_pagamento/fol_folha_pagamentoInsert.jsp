...
<form name="fol_folha_pagamento" action="portal.jsp" method="post"   > 
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/easyconstru/fol_folha_pagamento/fol_folha_pagamentoInsert.jsp"/>
    <center>     
	...
	<td>
		...
		<tr>
			<td colspan="2" align="center">
    			    <input type="button" value="Insert"  onClick="setOpPortal('fol_folha_pagamento','insert', '/easyEngenharia/easyconstru/fol_folha_pagamento/fol_folha_pagamentoInsert.jsp')" /> &nbsp;&nbsp;
    			    <input type="reset"  value="Clear" onclick="setOpPortal('fol_folha_pagamento','clear', '/easyEngenharia/easyconstru/fol_folha_pagamento/fol_folha_pagamentoInsert.jsp')"/>&nbsp;&nbsp;
    			    <input type="button" value="Voltar"  onClick="setOpPortal('fol_folha_pagamento','', '/easyEngenharia/easyconstru/fol_folha_pagamento/fol_folha_pagamentoConsult.jsp')" />
			</td>
		</tr>
    	</table>
    </center>     
