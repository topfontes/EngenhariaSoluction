...
<form name="pro_programacao" action="portal.jsp" method="post"   >                                         
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/easyconstru/pro_programacao/pro_programacaoUpdateDelete.jsp"/>
    <center>     
	...
	<td>
		<input type="text" name="pro_programacaoT.pro_nr_id" value="${pro_programacaoJB.pro_programacaoT.pro_nr_id}" onKeyPress="nextField(this, event)"/> 
	</td>
     </tr>
     <tr>
	<td>
	...
	<td>
	  ...
	  <tr>
		...
		<input type="button" value="Consult" onClick="setOpPortal('pro_programacao', 'consult', '/easyEngenharia/easyconstru/pro_programacao/pro_programacaoConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Update"  onClick="setOpPortal('pro_programacao', 'update' , '/easyEngenharia/easyconstru/pro_programacao/pro_programacaoUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Delete"  onClick="setOpPortal('pro_programacao', 'delete' , '/easyEngenharia/easyconstru/pro_programacao/pro_programacaoUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Cancel"  onClick="setOpPortal('pro_programacao', 'consult' , '/easyEngenharia/easyconstru/pro_programacao/pro_programacaoConsult.jsp')" />
    	    </td>
	  </tr>
	</table>
