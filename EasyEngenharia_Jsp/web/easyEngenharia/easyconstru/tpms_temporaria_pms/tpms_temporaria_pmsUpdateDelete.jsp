...
<form name="tpms_temporaria_pms" action="portal.jsp" method="post"   >                                         
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/easyconstru/tpms_temporaria_pms/tpms_temporaria_pmsUpdateDelete.jsp"/>
    <center>     
    ...
    <table align="center" border="0" width="50%">
    		     <tr>
	<td>
		<label>tmps_nr_id:</label>
	</td>
	<td>
		<input type="text" name="tpms_temporaria_pmsT.tmps_nr_id" value="${tpms_temporaria_pmsJB.tpms_temporaria_pmsT.tmps_nr_id}" onKeyPress="nextField(this, event)"/> 
	</td>
     </tr>
<tr>
	<td>
	...
	<td>
	  ...
	  <tr>
		...
		<input type="button" value="Consult" onClick="setOpPortal('tpms_temporaria_pms', 'consult', '/easyEngenharia/easyconstru/tpms_temporaria_pms/tpms_temporaria_pmsConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Update"  onClick="setOpPortal('tpms_temporaria_pms', 'update' , '/easyEngenharia/easyconstru/tpms_temporaria_pms/tpms_temporaria_pmsUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Delete"  onClick="setOpPortal('tpms_temporaria_pms', 'delete' , '/easyEngenharia/easyconstru/tpms_temporaria_pms/tpms_temporaria_pmsUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Cancel"  onClick="setOpPortal('tpms_temporaria_pms', 'consult' , '/easyEngenharia/easyconstru/tpms_temporaria_pms/tpms_temporaria_pmsConsult.jsp')" />
    	    </td>
	  </tr>
	</table>
