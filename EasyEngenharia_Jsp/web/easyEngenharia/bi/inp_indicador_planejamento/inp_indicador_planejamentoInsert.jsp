...
<form name="inp_indicador_planejamento" action="portal.jsp" method="post"   > 
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/bi/inp_indicador_planejamento/inp_indicador_planejamentoInsert.jsp"/>
...
<table align="left" width="600" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    			    <input type="button" class="ms-ButtonHeightWidth" value="Cadastrar"  onClick="setOpPortal('inp_indicador_planejamento','insert', '/easyEngenharia/bi/inp_indicador_planejamento/inp_indicador_planejamentoInsert.jsp')" /> &nbsp;&nbsp;
    			    <!--input type="reset"  value="Clear" onclick="setOpPortal('inp_indicador_planejamento','Limpar', '/easyEngenharia/bi/inp_indicador_planejamento/inp_indicador_planejamentoInsert.jsp')"/-->&nbsp;&nbsp;
    			    <input type="button" class="ms-ButtonHeightWidth" value="Voltar"  onClick="setOpPortal('inp_indicador_planejamento','', '/easyEngenharia/bi/inp_indicador_planejamento/inp_indicador_planejamentoConsult.jsp')" />
    </div></td>
  </tr>
</table>
<br/>
