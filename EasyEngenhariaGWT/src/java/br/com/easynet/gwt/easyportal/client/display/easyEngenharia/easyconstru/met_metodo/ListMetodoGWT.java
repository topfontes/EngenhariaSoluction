 ...
 */
package br.com.easynet.gwt.easyportal.client.display.easyEngenharia.easyconstru.met_metodo;

import br.com.easynet.gwt.easyportal.client.Constantes;
import br.com.easynet.gwt.easyportal.client.EasyAccessURL;
import br.com.easynet.gwt.easyportal.client.EasyContainer;
import br.com.easynet.gwt.easyportal.client.IListenetResponse;
import br.com.easynet.gwt.easyportal.client.display.easyEngenharia.easyconstru.transfer.Met_metodoTGWT;
import br.com.easynet.gwt.easyportal.client.display.easyEngenharia.easyconstru.transfer.Ope_operacaoTGWT;
...
public class ListMetodoGWT implements IListenetResponse {
    ...
    public static final String PAGE = "easyEngenharia/easyconstru/met_metodo/met_metodoConsultGWT.jsp";
...
//            param.put("per_perfilT.per_nr_id", per_perfilTGWT.getPer_nr_id()+"");
    ...
    public void povoaMetodosVinculadoPerfilSistema(Per_perfilTGWT per_perfilTGWT) {
        try {
            ...
            param.put("per_pefilT.per_nr_id", per_perfilTGWT.getPer_nr_id() + "");
            param.put("met_metodoT.sis_nr_id", "28");
            eaurl.accessJSonMapNoProgress(Constantes.URL + PAGE, param);
        } catch (Exception ex) {
        }
    }
        ...
        try {
            ...
            if (jsonValue != null && (jsonObject = jsonValue.isObject()) != null) {
                ...
                for (int i = 1; i < resultado.size(); i++) {
                    ...
                    met_metodoTGWT.setOpe_tx_nome(ope_tx_nome);
