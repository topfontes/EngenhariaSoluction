...
<form name="com_comenrcial" action="portal.jsp" method="post"   > 
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/bi/com_comenrcial/com_comenrcialInsert.jsp"/>
...
<table align="left" width="600" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    			    <input type="button" class="ms-ButtonHeightWidth" value="Cadastrar"  onClick="setOpPortal('com_comenrcial','insert', '/easyEngenharia/bi/com_comenrcial/com_comenrcialInsert.jsp')" /> &nbsp;&nbsp;
    			    <!--input type="reset"  value="Clear" onclick="setOpPortal('com_comenrcial','Limpar', '/easyEngenharia/bi/com_comenrcial/com_comenrcialInsert.jsp')"/-->&nbsp;&nbsp;
    			    <input type="button" class="ms-ButtonHeightWidth" value="Voltar"  onClick="setOpPortal('com_comenrcial','', '/easyEngenharia/bi/com_comenrcial/com_comenrcialConsult.jsp')" />
    </div></td>
  </tr>
</table>
<br/>
