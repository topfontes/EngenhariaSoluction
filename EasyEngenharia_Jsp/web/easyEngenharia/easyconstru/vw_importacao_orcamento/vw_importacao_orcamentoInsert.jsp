...
<form name="vw_importacao_orcamento" action="portal.jsp" method="post"   > 
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/easyconstru/vw_importacao_orcamento/vw_importacao_orcamentoInsert.jsp"/>
    <center>     
	...
	<td>
		...
		<tr>
			<td colspan="2" align="center">
    			    <input type="button" value="Insert"  onClick="setOpPortal('vw_importacao_orcamento','insert', '/easyEngenharia/easyconstru/vw_importacao_orcamento/vw_importacao_orcamentoInsert.jsp')" /> &nbsp;&nbsp;
    			    <input type="reset"  value="Clear" onclick="setOpPortal('vw_importacao_orcamento','clear', '/easyEngenharia/easyconstru/vw_importacao_orcamento/vw_importacao_orcamentoInsert.jsp')"/>&nbsp;&nbsp;
    			    <input type="button" value="Voltar"  onClick="setOpPortal('vw_importacao_orcamento','', '/easyEngenharia/easyconstru/vw_importacao_orcamento/vw_importacao_orcamentoConsult.jsp')" />
			</td>
		</tr>
    	</table>
    </center>     
