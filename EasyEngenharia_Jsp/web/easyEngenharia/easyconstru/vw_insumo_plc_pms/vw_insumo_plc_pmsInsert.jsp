...
<form name="vw_insumo_plc_pms" action="portal.jsp" method="post"   > 
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/easyconstru/vw_insumo_plc_pms/vw_insumo_plc_pmsInsert.jsp"/>
    <center>     
	...
	<td>
		...
		<tr>
			<td colspan="2" align="center">
    			    <input type="button" value="Insert"  onClick="setOpPortal('vw_insumo_plc_pms','insert', '/easyEngenharia/easyconstru/vw_insumo_plc_pms/vw_insumo_plc_pmsInsert.jsp')" /> &nbsp;&nbsp;
    			    <input type="reset"  value="Clear" onclick="setOpPortal('vw_insumo_plc_pms','clear', '/easyEngenharia/easyconstru/vw_insumo_plc_pms/vw_insumo_plc_pmsInsert.jsp')"/>&nbsp;&nbsp;
    			    <input type="button" value="Voltar"  onClick="setOpPortal('vw_insumo_plc_pms','', '/easyEngenharia/easyconstru/vw_insumo_plc_pms/vw_insumo_plc_pmsConsult.jsp')" />
			</td>
		</tr>
    	</table>
    </center>     
