...
public class MontarTreeGWT {
    ...
    public MontarTreeGWT(List lista, String tx_id_super, String tx_id, String display,String titulo){
        this.setList(lista);
        this.setDisplay(display);
        this.setId(tx_id);
        this.setId_super(tx_id_super);
 ...
 */
    ...
    private void povoaSuper(List<Model> list, String tx_id_super) {
        try {
