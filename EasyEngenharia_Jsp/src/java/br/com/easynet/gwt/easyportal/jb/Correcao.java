...
public class Correcao extends SystemBase {
    ...
    public void preencherListas() {
        ...
        try {
            ...
            while ((row = tblConta.getNextRow()) != null) {
                ...
                contaOrcamentoT.setCodigo_externo((String) row.get("ITOR1_COD_ITEM"));
...
//                System.out.println(contaTemp.getCodigo_externo() +" - "+contaTemp.getCodigo() +" - "+ orcamentoT.getCod_conta()+" - "+orcamentoT.getQtde());
    ...
    public void insertServicoObra(Plco_plano_contas_orcamentoT pt,String nome) throws Exception {
        try {
            Dso_descricao_servico_obraDAO ddao = getDso_descricao_servico_obraDAO();
    ...
    public void insertPlco(String codigo_externo, String nome) throws Exception {
        try {
...
//        }
    ...
    public void povoaOrcamento(int cod_super) throws Exception {
        try {
            ...
            for (OrcamentoT orcT : listTemp) {
                ...
                insertPlco(orcT.getCod_externo(), orcT.getPlco_nome());
                qtde_servico = 0;
    ...
    public float povoaComposicao(int id_suber_composicao, float base) throws Exception {
        ...
        for (ComposicaoT compT : listComp) {
            ...
            if (!existe) {
                ...
                insertPlco(compT.getCod_externo(), compT.getPlco_nome());
            } else {
    ...
    public void importar() throws IOException, BiffException {
        try {
            iniciarTransection();
            salvarArquivo();
            preencherListas();
