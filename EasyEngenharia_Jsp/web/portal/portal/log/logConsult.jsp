...
<form name="log" action="portal.jsp" method="post">                                         
    ...
    <div align="center">     
        ...
        <img src="/easyportal/images/btcalendar1.gif" border="0"  onclick="openCalendar(document.log.elements['datainicial'], true)"/>
        <br/>
        <label>Data:</label> <input name="datafinal" value="${logJB.datafinal}"/>
        <img src="/easyportal/images/btcalendar1.gif" border="0"  onclick="openCalendar(document.log.elements['datafinal'], true)"/>
        <br/>
        <label>Status:</label> 
