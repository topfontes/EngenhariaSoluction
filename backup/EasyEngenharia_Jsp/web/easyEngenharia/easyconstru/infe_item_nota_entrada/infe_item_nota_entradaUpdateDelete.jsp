...
<form name="infe_item_nota_entrada" action="portal.jsp" method="post"   >                                         
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/easyconstru/infe_item_nota_entrada/infe_item_nota_entradaUpdateDelete.jsp"/>
    <center>     
    ...
    <table align="center" border="0" width="50%">
    		     <tr>
	<td>
		<label>infe_nr_id:</label>
	</td>
	<td>
		<input type="text" name="infe_item_nota_entradaT.infe_nr_id" value="${infe_item_nota_entradaJB.infe_item_nota_entradaT.infe_nr_id}" onKeyPress="nextField(this, event)"/> 
	</td>
     </tr>
     <tr>
	<td>
...
<tr>
	...
	<td>
	  ...
	  <tr>
		...
		<input type="button" value="Consult" onClick="setOpPortal('infe_item_nota_entrada', 'consult', '/easyEngenharia/easyconstru/infe_item_nota_entrada/infe_item_nota_entradaConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Update"  onClick="setOpPortal('infe_item_nota_entrada', 'update' , '/easyEngenharia/easyconstru/infe_item_nota_entrada/infe_item_nota_entradaUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Delete"  onClick="setOpPortal('infe_item_nota_entrada', 'delete' , '/easyEngenharia/easyconstru/infe_item_nota_entrada/infe_item_nota_entradaUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Cancel"  onClick="setOpPortal('infe_item_nota_entrada', 'consult' , '/easyEngenharia/easyconstru/infe_item_nota_entrada/infe_item_nota_entradaConsult.jsp')" />
    	    </td>
	  </tr>
	</table>
