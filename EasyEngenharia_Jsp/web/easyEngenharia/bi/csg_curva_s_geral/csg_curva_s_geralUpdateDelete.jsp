...
<form name="csg_curva_s_geral" action="portal.jsp" method="post"   >                                         
    ...
    <input type="hidden" name="urlCanal" value="/easyEngenharia/bi/csg_curva_s_geral/csg_curva_s_geralUpdateDelete.jsp"/>
<!-- Titulo da Operacao-->
...
<table width="600" align="left" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    		<input type="button" value="Alterar" class="ms-ButtonHeightWidth" onClick="setOpPortal('csg_curva_s_geral', 'update' , '/easyEngenharia/bi/csg_curva_s_geral/csg_curva_s_geralUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Excluir" class="ms-ButtonHeightWidth" onClick="setOpPortal('csg_curva_s_geral', 'delete' , '/easyEngenharia/bi/csg_curva_s_geral/csg_curva_s_geralUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
		<input type="button" value="Voltar" class="ms-ButtonHeightWidth" onClick="setOpPortal('csg_curva_s_geral', 'consult', '/easyEngenharia/bi/csg_curva_s_geral/csg_curva_s_geralConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<!--input type="button" value="Cancel" class="ms-ButtonHeightWidth"  onClick="setOpPortal('csg_curva_s_geral', 'consult' , '/easyEngenharia/bi/csg_curva_s_geral/csg_curva_s_geralConsult.jsp')" /-->
...
<br/>
	...
	<td class="ms-standardheader">
		csg_nr_id:<span class="style1">*</span>
	</td>
	<td class="ms-fields">
		<label class="ms-standardheader">
  		  <input type="text" name="csg_curva_s_geralT.csg_nr_id" value="${csg_curva_s_geralJB.csg_curva_s_geralT.csg_nr_id}" onKeyPress="nextField(this, event)"/> 
   	       </label>
	</td>
     </tr>
     <tr>
